...
class CategoryTest(TestCase):
    ...
    def create_Category(self, nameCategory='Cat1', idCategory='idCat1'):
        return Category.objects.create(nameCategory=nameCategory, idCategory=idCategory)
    ...
    def create_Products(self):
        ...
        idCategory=(c)
        idStore=(s)
        return Products.objects.create(nameAlim=nameAlim, image=image, url=url, descriptionAlim=descriptionAlim, 
                                       nutritionGrade=nutritionGrade, idCategory=idCategory, idStore=idStore)
